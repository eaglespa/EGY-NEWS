      ...
      <div className="relative h-full">
        ...
        >
          <div className="relative aspect-[16/10] overflow-hidden">
            <ArtImage seed={article.imageSeed} className="h-full w-full transition-transform duration-500 group-hover:scale-[1.06]" />
            ...
            {article.breaking && (
              <span className="live-dot absolute bottom-3 start-3 rounded-full bg-alert px-2.5 py-1 font-mono text-[10px] font-black tracking-[0.16em] text-black uppercase">
        ...
        <BookmarkButton slug={article.slug} label={bm.save} />
      </div>
    </TiltCard>
  );
}
